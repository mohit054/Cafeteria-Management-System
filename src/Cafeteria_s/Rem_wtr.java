 ...
 * @author majid
 */
public class Rem_wtr extends javax.swing.JFrame {
    Connection con;
    Statement stmt;
    ResultSet rs;
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(92, 196, 90, 30);
        ...
        jButton2.setBounds(222, 196, 80, 30);
        ...
        jLabel8.setText("WAITER   REMOVAL");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String s="delete from wreg where wid='"+jTextField1.getText()+"';";
    ...
    private void jTextField1CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1CaretUpdate
        ...
        try{
            Class.forName("java.sql.Driver");
            String a="select wname,wcont from wreg where wid='"+jTextField1.getText()+"';";
            rs=stmt.executeQuery(a);
            while(rs.next())
            {
                String Name=rs.getString("wname");
                String Number=rs.getString("wcont");
