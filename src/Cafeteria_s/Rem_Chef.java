 ...
 * @author majid
 */
public class Rem_Chef extends javax.swing.JFrame {
    Connection con;
    Statement stmt;
    ResultSet rs;
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(92, 203, 90, 23);
        ...
        jButton2.setBounds(222, 203, 90, 23);
        ...
        jLabel4.setBounds(92, 142, 120, 14);
        ...
        logout.setBounds(398, 18, 80, 23);

        setSize(new java.awt.Dimension(506, 339));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String s="delete from chreg where chid='"+jTextField1.getText()+"';";
    ...
    private void jTextField1CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1CaretUpdate
        ...
        try{
            Class.forName("java.sql.Driver");
            String a="select chname,chcont from chreg where chid='"+jTextField1.getText()+"';";
            rs=stmt.executeQuery(a);
            while(rs.next())
            {
                String Name=rs.getString("chname");
                String Number=rs.getString("chcont");
