 ...
 * @author majid
 */
public class Rem_Cus extends javax.swing.JFrame {
    Connection con;
    Statement stmt;
    ResultSet rs;
    ...
    private void initComponents() {
        ...
        jButton1.setBounds(92, 203, 100, 23);
        ...
        jLabel4.setBounds(92, 142, 90, 14);

        jLabel3.setText("Name:");
        getContentPane().add(jLabel3);
        jLabel3.setBounds(92, 110, 70, 14);

        jLabel2.setText("Enter Customer  ID:");
        getContentPane().add(jLabel2);
        jLabel2.setBounds(92, 78, 120, 14);
        ...
        jLabel8.setText("CUSTOMER  REMOVAL");
        ...
        setSize(new java.awt.Dimension(489, 298));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try{
            ...
            String s="delete from creg where cid='"+jTextField1.getText()+"';";
    ...
    private void jTextField1CaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_jTextField1CaretUpdate
        ...
        try{
            Class.forName("java.sql.Driver");
            String a="select cname,ccont from creg where cid='"+jTextField1.getText()+"';";
